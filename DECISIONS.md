...
**Revisit when:** a golden set weighted toward exact-identifier queries still fails to separate hybrid from dense — try 0.6/0.4 before concluding fusion doesn't pay.
